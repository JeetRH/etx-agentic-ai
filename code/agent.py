...
def run_agent(pod_name, namespace):
    ...
    #     '{"owner":"JeetRH","repo":"etx-agentic-ai",'
    ...
    try:
        ...
        fallback_prompt = (
            ...
            "Then create a Github issue with owner 'JeetRH', repo 'etx-agentic-ai', "
